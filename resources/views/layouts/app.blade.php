    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <div class="brand-icon" style="background:transparent;border:none;">
                <img src="{{ asset('images/logo.png') }}" alt="Dot.Plug" style="width:32px;height:32px;object-fit:contain;">
            </div>
            <div>
                <div class="brand-name">Dot.Plug</div>
                <div class="brand-status">
                    <div class="live-dot"></div>
                    <span class="brand-subtitle">Extension Marketplace</span>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('extensions.index') }}" class="nav-item {{ request()->routeIs('extensions.*') ? 'active' : '' }}">
                <span class="material-symbols-rounded nav-icon">extension</span>
                Marketplace
            </a>
